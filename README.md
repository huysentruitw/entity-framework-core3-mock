...
This repository is for EF Core 3.x support. If you've already upgraded to EF Core 5, please visit [this repository](https://github.com/huysentruitw/entity-framework-core-mock).
